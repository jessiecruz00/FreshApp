...
export default function DashboardSettingsPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-[var(--muted)]">Profile and preferences</p>
      <form onSubmit={handleSubmit} className="mt-8 max-w-md space-y-6">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="emailNotif" className="text-sm text-[var(--foreground)]">
            Email notifications
          </label>
        </div>
        <div className="flex items-center gap-2">
          <input
            ...
            className="rounded border-[var(--border)]"
          />
          <label htmlFor="pushNotif" className="text-sm text-[var(--foreground)]">
            Push notifications
          </label>
        </div>
